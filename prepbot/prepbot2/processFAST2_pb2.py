...
mux_to(FORMALIN)
sleep(1)
pump_to_ml(1.5, speed=100)
wait_move_done()
sleep(5)
mux_to('CAS1')
sleep(1)
pump_to_ml(0.2, speed=20)
wait_move_done()
countdown(1200)
...
wait_move_done()
sleep(1)
pump_to_ml(1.5, speed=200)
wait_move_done()
sleep(2)
mux_to('CAS1')
pump_to_ml((1.5-LINEVOL_1), speed=20)
wait_move_done()
sleep(10)
pump_to_ml(0.1, speed=20)
countdown(80)
pump_to_ml(0, speed=20)
wait_move_done()
sleep(4)
mux_to(MEOH)
wait_move_done()
sleep(1)
pump_to_ml(1.5, speed=20)
wait_move_done()
sleep(2)
mux_to('CAS1')
wait_move_done()
...
print('ADDING BABB')
mux_to(BABB)
pump_to_ml(1.25, speed=20)
wait_move_done()
sleep(5)
mux_to('CAS1')
sleep(1)
pump_to_ml(0.4, speed=20)
wait_move_done()
countdown(120)
pump_to_ml(0, speed=20)
wait_move_done()
